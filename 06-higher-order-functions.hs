...
higherOrderSequenceApplication eachDo betweenDo start end 
    | start >= end = end
    | otherwise = foldl1 betweenDo (map eachDo [start..end]) 

-- Define a factorial method using the higherOrderSequenceAppliction
hoFactorial :: Int -> Int
hoFactorial 0 = 1
hoFactorial n = higherOrderSequenceApplication (*1) (*) 1 n
